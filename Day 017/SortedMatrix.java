...
public class SortedMatrix {
    ...
    // search in the row provided  between the cols provide
    ...
    static int[] search(int[][] matrix, int target) {
        ...
        // run the loop till 2 rowsare remaining
        while (rowStart < (rowEnd - 1)) { // while this is true it will have than 2 rows
